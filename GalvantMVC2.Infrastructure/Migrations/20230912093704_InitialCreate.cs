    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Location2Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Location2Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Location2s", x => x.Location2Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location2Id = table.Column<int>(type: "int", nullable: true),
                    Location3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipment_Location2s_Location2Id",
                        column: x => x.Location2Id,
                        principalTable: "Location2s",
                        principalColumn: "Location2Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ForkliftId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Forklifts_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GantryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Producer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductionYear = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    InventoryNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LiftingCapacity = table.Column<decimal>(type: "decimal(9,2)", nullable: true),
                    Range = table.Column<decimal>(type: "decimal(9,2)", nullable: true),
                    RaisingHeight = table.Column<decimal>(type: "decimal(9,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gantries", x => x.GantryId);
                    table.ForeignKey(
                        name: "FK_Gantries_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Forklifts_EquipmentId",
                table: "Forklifts",
                column: "EquipmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Gantries_EquipmentId",
                table: "Gantries",
                column: "EquipmentId",
                unique: true);
        }
