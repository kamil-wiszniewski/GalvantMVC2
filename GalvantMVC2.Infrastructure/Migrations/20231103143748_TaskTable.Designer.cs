...
namespace GalvantMVC2.Infrastructure.Migrations
{
    ...
    [Migration("20231103143748_TaskTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GalvantMVC2.Domain.Model.Status", b =>
                {
            ...
            modelBuilder.Entity("GalvantMVC2.Domain.Model.TaskEmployee", b =>
                {
                    b.Property<int>("TaskId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GalvantMVC2.Domain.Model.TaskFile", b =>
                {
            ...
            modelBuilder.Entity("GalvantMVC2.Domain.Model.Task", b =>
                {
                    ...
                    b.HasOne("GalvantMVC2.Domain.Model.Status", "Status")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("GalvantMVC2.Domain.Model.TaskEmployee", b =>
                {
                    b.HasOne("GalvantMVC2.Domain.Model.Employee", "Employee")
                        .WithMany("TaskEmployee")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GalvantMVC2.Domain.Model.Task", "Task")
                        .WithMany("TaskEmployee")
